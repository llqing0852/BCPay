...
namespace MallMan
{
    public partial class CallBackForm : Form
    {
        ...
        private void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            var client = new RestClient($"http://122.147.254.10:8010/pay-admin/api/v1/ali_notify?outTradeNo={tbSysTradeNo.Text.Trim()}&tradeNo={tbTradeNo.Text.Trim()}&orderAmt={tbOrderAmt.Text.Trim()}");
